"""Simulador offline das transições do PlanGraph do controlador real.

O módulo não importa ROS nem executa movimentos. Ele reproduz apenas as regras
de decisão de ``decide_send_action`` e a atualização de estado que ocorre após
uma ação ser concluída com sucesso.
"""

from copy import deepcopy
from typing import Any, Dict, List, Optional, Tuple

from datacol import INTENTION_LIST
